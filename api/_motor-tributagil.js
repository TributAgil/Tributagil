...
2. Check de Interrupção (Art. 174, CTN): Verifique se há despacho que ordena a citação (se após 09/06/2005), protesto, parcelamento ou PAGAMENTO (ainda que parcial — art. 174, parágrafo único, IV: qualquer ato inequívoco de reconhecimento do débito pelo devedor). Se achou: a contagem zera e recomeça desta data. (Atenção: execuções anteriores a 08/06/2005 só interrompem com a citação pessoal).
