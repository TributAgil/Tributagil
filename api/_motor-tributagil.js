...
- SITUAÇÃO 1 — Ofício, ou Homologação sem base de cálculo (art. 173, I, CTN — Súmula 555/STJ): Aplica-se quando o lançamento é TIPO C, OU quando é TIPO B mas o contribuinte não declarou nem pagou nada (nada a homologar), OU quando há dolo/fraude/simulação comprovada documentalmente. Quando o motivo for ausência de declaração e de pagamento, cite expressamente no parecer a Súmula 555 do STJ: "Quando não houver declaração do débito, o prazo decadencial quinquenal para o Fisco constituir o crédito tributário rege-se pelo art. 173, I, do CTN." Data de Início = 1º de janeiro do ano seguinte ao Fato Gerador. Se Data Atual > (Data de Início + 5 anos) => "Decadência reconhecida". Caso contrário => "Decadência não configurada — restam [X] dias/meses/anos para o prazo decadencial".
ATENÇÃO — ÔNUS DA PROVA DO DOLO/FRAUDE: O ônus de provar dolo, fraude ou simulação é do Fisco. Antes de aplicar a Situação 1 com base nessa hipótese, confirme que existe um documento específico que a sustente (ex.: Auto de Infração fundamentado, relatório de fiscalização detalhado, decisão administrativa que reconheça a fraude). Se o Fisco apenas alegar dolo/fraude sem essa comprovação documental específica, NÃO aplique a Situação 1 por esse motivo — reclassifique o caso conforme os fatos realmente comprovados de pagamento e declaração (Situação 2 ou Situação 3, conforme o caso).
